...
protected void service(HttpServletRequest req, HttpServletResponse resp) 
		throws ServletException, IOException {			
			...
			out.println("<table border=1 style='border-collapse:collapse;text-align:center;'><tr><th>번호</th><th>나라</th><th>수도</th><th>인구</th></tr>"
					...
					+ "<tr><td>4</td><td>중국</td><td>베이징</td><td>2100만</td></tr></table>");
			out.close();
